...
public class Main {
    public static void main(String[] args) {
        ...
        while (flag) {
            ...
            if (choice.equals("1")) System.out.println(tree.getTree());
                ...
                System.out.println("1. Показать детей\n2. Показать мать\n3. Показать отца\n4. В основное меню");
                System.out.print("Выберите действие : ");
                choice = iScanner.next();
                if (choice.equals("1")) tree.getInfoChildren(name);
                else if (choice.equals("2")) tree.getInfoMother(name);
                else if (choice.equals("3")) tree.getInfoFather(name);
